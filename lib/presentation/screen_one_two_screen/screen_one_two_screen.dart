import 'package:flutter/material.dart';import 'package:snap_chat_application/core/app_export.dart';import 'package:snap_chat_application/widgets/custom_elevated_button.dart';class ScreenOneTwoScreen extends StatelessWidget {const ScreenOneTwoScreen({Key? key}) : super(key: key);
...
/// Navigates to the screen21TwoScreen when the action is triggered.
///
/// The [BuildContext] parameter is used to build the navigation stack.
/// When the action is triggered, this function uses the [Navigator] widget
/// to push the named route for the screen21TwoScreen.
onTapTxtCreateaccount(BuildContext context) { Navigator.pushNamed(context, AppRoutes.screen21TwoScreen); } 
 }
